      ...
      <div>
        <header>
          <div className="account">
            <div>Available balances: <span>{balance/1000000000000000000000000} BRD,</span> <span>{currentUser.balance/1000000000000000000000000} NEAR</span> <span>{currentUser.accountId}</span></div>
          </div>
